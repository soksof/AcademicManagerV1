...
<nav id="menu_box">
  <ul class="menu">
	...
	<section id="middle">
	<!--Η γραμματεία ψάχνει με το CourseID ή το StudentID 
	και εμφανίζεται η βαθμολογία όλων των φοιτητών στο 
	μάθημα ή ενός φοιτητή σε όλα τα μαθήματα-->
	<h3>Search by courseID to dipslay all students' grades or by studentID to display his/her grades</h3>
			<p><input type="search"/><button type="button">Search</button></p>
