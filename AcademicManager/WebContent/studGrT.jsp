...
<nav id="menu_box">
  <ul class="menu">
	...
	<section id="middle">
	<!--Ο καθηγητής επιλέγει από dropdown το μάθημα 
	και βλέπει για όλους τους φοιτητές συνολική εικόνα 
	αξιολόγησης: assignments, final grade, λεκτική αξιολόγηση-->
		<h3>Choose one of your courses to dipslay students' overall evaluation</h3>
		<select>
