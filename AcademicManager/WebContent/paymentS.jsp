...
<nav id="menu_box">
  <ul class="menu">
	...
	<section id="middle">
	<!--H γραμματεία ψάχνει με CourseID ή StudentID 
	και εμφανίζει τις πληρωμές ανά μάθημα ή ανά φοιτητή-->
	<h3>Search by courseID or by studentID to display payments</h3>
		<p>Search <input type="search"/><input type="submit" value="Submit"></p>
